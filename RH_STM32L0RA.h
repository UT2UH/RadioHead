...
// RHF76-052, S76S, S76G, LGT92 fork - UT2UH
// Copyright (C) 2020 Mike McCauley
// $Id: RH_STM32L0RA.h,v 1.2 2021/12/16 23:39:39 mikem Exp $
// 
#ifndef RH_STM32L0RA_h
#define RH_STM32L0RA_h

#include <RH_RF95.h>

/////////////////////////////////////////////////////////////////////
/// \class RH_STM32L0RA RH_STM32L0RA.h <RH_STM32L0RA.h>
...
class RH_STM32L0RA : public RH_RF95
{
public:
    /// Constructor
    RH_STM32L0RA();
...
private:
    ...
    static RH_STM32L0RA* _thisDevice;
