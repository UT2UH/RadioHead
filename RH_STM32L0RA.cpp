...
// $Id: RH_STM32L0RA.cpp,v 1.1 2022/01/26 23:39:39 mikem Exp $
...
RH_STM32L0RA* RH_STM32L0RA::_thisDevice;
...
void RH_INTERRUPT_ATTR RH_STM32L0RA::isr()
{
    _thisDevice->handleInterrupt();
}

RH_STM32L0RA::RH_STM32L0RA():
    RH_RF95(RH_INVALID_PIN, RH_INVALID_PIN)
{
}

bool RH_STM32L0RA::init()
{
    _thisDevice = this;
...
void  RH_STM32L0RA::selectSlave()
{
    stm32l0_gpio_pin_write(RADIO_NSS, 0);
}

void  RH_STM32L0RA::deselectSlave()
{
   stm32l0_gpio_pin_write(RADIO_NSS, 1);
}
    
bool RH_STM32L0RA::modeWillChange(RHMode mode)
{
    if (mode == RHModeTx)
    {
#if defined (ARDUINO_LGT92) || defined (ARDUINO_K92_L072Z)
